...
from threeddfa.utils.functions import cv_draw_landmark, get_suffix
...
if __name__ == '__main__':
    ...
    # Default path relative to the script's location (threeddfa/demo_video.py)
    # to access threeddfa/configs/mb1_120x120.yml
    parser.add_argument('-c', '--config', type=str, default='/home/pawan/3DDFA_V2_Dep/threeddfa/configs/mb1_120x120.yml')
